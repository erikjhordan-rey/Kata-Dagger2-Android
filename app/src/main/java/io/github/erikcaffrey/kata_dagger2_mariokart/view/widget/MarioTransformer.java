...
public class MarioTransformer implements ViewPager.OnPageChangeListener, ViewPager.PageTransformer {
  ...
  public MarioTransformer(ViewPager viewPager, CharacterAdapter adapter) {
    pager = viewPager;
